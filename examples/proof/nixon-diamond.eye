  ...
  proof(
    ...
    uses([
      proof(
        ...
        by(rule("nixon-diamond.eye", clause(7))),
        bindings([binding("?person", nixon)]),
        uses([
          proof(
            goal(kind(nixon, republican)),
            by(fact("nixon-diamond.eye", clause(5)))
          )
        ])
      )
    ])
      ...
      proof(
        ...
        uses([
          ...
          proof(
            ...
            by(fact("nixon-diamond.eye", clause(8)))
          )
        ])
      )
    ])
      ...
      proof(
        ...
        uses([
          ...
          proof(
            ...
            by(fact("nixon-diamond.eye", clause(9)))
          )
        ])
      )
    ])
...
why(
  ...
  proof(
    ...
    by(rule("nixon-diamond.eye", clause(13))),
