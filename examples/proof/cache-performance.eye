      ...
      proof(
        ...
        uses([
          proof(
            ...
            by(fact("cache-performance.eye", clause(5)))
          ),
          proof(
            goal(total_requests(api_cache, 10000.0)),
            by(rule("cache-performance.eye", clause(8))),
...
why(
  ...
  proof(
    ...
    by(rule("cache-performance.eye", clause(14))),
    bindings([binding("?cache", api_cache)]),
    uses([
      proof(
        goal(cache_effective(api_cache)),
        by(rule("cache-performance.eye", clause(11))),
        ...
        uses([
          ...
          proof(
            ...
            by(fact("cache-performance.eye", clause(6)))
          ),
          proof(
          ...
          proof(
            ...
            by(fact("cache-performance.eye", clause(7)))
          ),
          proof(
            goal(lt(15.5, 20.0)),
            by(builtin(lt, 2))
...
why(
  ...
  proof(
    ...
    by(rule("cache-performance.eye", clause(15))),
    bindings([binding("?cache", api_cache)]),
    uses([
      proof(
        goal(cache_effective(api_cache)),
