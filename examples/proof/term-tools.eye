...
why(
  ...
  proof(
    ...
    by(rule("term-tools.eye", clause(4))),
...
why(
  ...
  proof(
    ...
    by(rule("term-tools.eye", clause(5))),
...
why(
  ...
  proof(
    ...
    by(rule("term-tools.eye", clause(6))),
...
why(
  ...
  proof(
    ...
    by(rule("term-tools.eye", clause(7))),
...
why(
  ...
  proof(
    ...
    by(rule("term-tools.eye", clause(8))),
...
why(
  ...
  proof(
    ...
    by(rule("term-tools.eye", clause(9))),
    uses([
      proof(
