...
why(
  ...
  proof(
    ...
    by(rule("electrical-rc-filter.eye", clause(10))),
    bindings([binding("?filter", filter1), binding("?tau", 0.01)]),
    uses([
      proof(
        goal(time_constant(filter1, 0.01)),
        by(rule("electrical-rc-filter.eye", clause(7))),
      ...
      proof(
        ...
        uses([
          ...
          proof(
            ...
            by(fact("electrical-rc-filter.eye", clause(6)))
          ),
          proof(
